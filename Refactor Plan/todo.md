...
#### 4.1 Model Changes
- [x] **Add `archived: Bool`** to Project model ✅
- [x] **Update ProjectManager** to handle archived status ✅
- [x] **Update JSON encoding/decoding** for archived field ✅
- [x] **Ensure default value** is `false` for new projects ✅

#### 4.2 Behavior Implementation
- [x] **Hide archived projects** from menu bar dropdown ✅
- [x] **Show archived projects** in Projects Manager ✅
- [x] **Add "Archived" section** in Projects Manager ✅
- [x] **Add "Archive" action** in Projects Manager ✅
- [x] **Maintain archived projects** in:
  - [x] Dashboard charts ✅
  - [x] Annual Story View ✅
  - [x] Filters and reports ✅

#### 4.3 Developer Brief Implementation
- [x] **Add `archived` boolean** to Project model ✅
- [x] **Hide archived projects** in menu bar dropdown ✅
- [x] **Optionally grey them out** or separate in Projects Manager ✅
- [x] **Add "Archive" action** in Projects Manager ✅
- [x] **Ensure archived projects** still appear in historical views ✅
- [x] **Add archive checkbox** to Project Add/Edit form ✅
- [x] **Restore from archive** with slider ✅
